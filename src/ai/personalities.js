...
export function difficultyTuning(id) {
  ...
  const T = {
    ...
    chill: {
      ...
      lastStealMult: 0.15, lastDecide: 1.4, easeBeat: 2.5, easeTempo: 0.3,
    },
    normal: {
      ...
      lastStealMult: 0.4, lastDecide: 1.2, easeBeat: 2, easeTempo: 0.25,
    },
    chaos: {
      ...
      lastStealMult: 1, lastDecide: 1, easeBeat: 0, easeTempo: 0,
    },
